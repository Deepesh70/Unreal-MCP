...
Usage:
    from unreal_mcp.agents.vision import capture_screenshot, critique_scene, auto_refine
"""
...
from unreal_mcp.agents.processor import _discover_city_manager, _handle_unreal_intent
